...
export default function Page() {
	...
	useEffect(() => {
		...
		const CreateNewCv = async () => {
			try {
				const response = await fetch("/api/beta-make-resume", {
					method: "POST",
					headers: {
		...
		<>
			...
			{!newCv ? (
				...
				<div className="p-8 print:p-0">
					...
					{error && <ErrorAlert err={error} />}
					<div className="w-4xl p-12 border rounded-2xl text-center bg-white space-y-3 shadow-sm print:shadow-none print:w-4xl print:px-22 print:border-none">
