...
export default function PDFUploader({ onUploadSuccess }: PDFUploaderProps) {
	...
	const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
		e.preventDefault(); // This is crucial to prevent the default form submission (page reload)
					...
					<div className="space-y-4">
						{selectedFile ? (
							...
							<>
								...
								>
									<svg
										className={`w-8 h-8 transition-colors ${dragActive ? "text-blue-600" : "text-gray-500"
											}`}
										fill="none"
										stroke="currentColor"
										viewBox="0 0 24 24"
