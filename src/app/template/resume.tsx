...
export default function ResumeComponent() {
	...
	const { userDetails, workExperience, education, projects, skills } =
		resumeData;
	return (
		<div className="w-full p-6 bg-gray-50 print:w-6xl print:p-0 print:m-0 ">
			<DowloadPdf username={userDetails.name} />
			<div className=" bg-white w-6xl mx-auto break-words p-6 px-8 text-[15px] space-y-4 text-gray-700   border border-gray-200 print:border-none print:w-[1120px] print:mt-6">
				<GreyLine>
